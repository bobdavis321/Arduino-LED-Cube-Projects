// 8x8x8 LED Cube with 74595's falling rain demo
...
int rdata1 = random(64);
int rdata2 = random(64);
int rdata3 = random(64);
int rdata4 = random(64);
int rdata5 = random(64);
int rdata6 = random(64);
int rdata7 = random(64);
int rdata8 = random(64);
